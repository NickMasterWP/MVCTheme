                ...
                if ($field["type"] === "repeater") {
                    ...
                    foreach ($_POST[$name] as $index => $item) {
                        ...
                        foreach ($field["options"] as $subField) {
                            if ($subField["type"] !== "tinymce" && $subField["type"] !== "textarea") {
                                $valueItem = sanitize_text_field($item[$subField["name"]] ?? '');
                            }  else {
                                $valueItem = $item[$subField["name"]] ?? '';

                            }
                            $row[$subField["name"]] = $valueItem;
                        }
                        $value[] = $row;
                    }
