<div class="mvc-box-field">
    ...
    <div class="mvc-field b-field__image ">
        <?php
            $image_url = $args["value"] ? wp_get_attachment_url($args["value"]) : '';
        ?>
        <div class="mvc-field-image <?= $args["value"] == "" ? "a-field-image-hide" : "";?>  js-mvc-image-<?= $args["name"];?>">
            <div class="mvc-field-image-container"><img src="<?= $image_url;?>" id="custom_image_preview_<?= $args["name"];?>"></div>
